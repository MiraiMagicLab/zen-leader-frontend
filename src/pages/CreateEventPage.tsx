              ...
              <div className="space-y-3">
                ...
                {venue.trim() ? (
                  <a
                    ...
                    className="flex w-full items-center gap-2 rounded-xl border border-border bg-accent/40 px-3 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent/60"
                  >
          ...
          <div className="rounded-xl border bg-card p-5 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <div className="mt-0.5 flex justify-between text-xs font-medium text-muted-foreground/70">
